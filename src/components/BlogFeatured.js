...
function BlogFeatured({ blog }) {
  return (
    <div className="card w-full p-6 rounded-3xl hover:bg-hover-card transition ease-in-out hover:outline outline-2 outline-hover-border duration-150 cursor-pointer">
